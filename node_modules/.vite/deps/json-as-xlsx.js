...
var init_xlsx = __esm({
  "node_modules/xlsx/xlsx.mjs"() {
    ...
    SSFbasedate = new Date(1899, 11, 31, 0, 0, 0);
    ...
    refdate = new Date();
    dnthresh = basedate.getTime() + (refdate.getTimezoneOffset() - basedate.getTimezoneOffset()) * 6e4;
    refoffset = refdate.getTimezoneOffset();
    good_pd_date_1 = new Date("2017-02-19T19:06:09.000Z");
    good_pd_date = isNaN(good_pd_date_1.getFullYear()) ? new Date("2/19/17") : good_pd_date_1;
    good_pd = good_pd_date.getFullYear() == 2017;
    lower_months = ["january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december"];
    split_regex = function() {
    ...
    tagregex2 = /<[^>]*>/g;
    tagregex = XML_HEADER.match(tagregex1) ? tagregex1 : tagregex2;
    nsregex = /<\w*:/;
    nsregex2 = /<(\/?)\w+:/;
    encodings = {
      "&quot;": '"',
    ...
    utf8corpus = "foo bar bazâð£";
    utf8read = has_buf && (utf8readc(utf8corpus) == utf8reada(utf8corpus) && utf8readc || utf8readb(utf8corpus) == utf8reada(utf8corpus) && utf8readb) || utf8reada;
    ...
    rs_to_html = function parse_rs_factory() {
      var nlregex = /(\r\n|\n)/g;
    ...
    crypto_CreateXorArray_Method1 = function() {
    ...
    parse_sty_xml = function make_pstyx() {
    ...
    clrsregex = /<a:clrScheme([^>]*)>[\s\S]*<\/a:clrScheme>/;
    ...
    sheetprregex2 = /<(?:\w:)?sheetPr[^>]*(?:[\/]|>([\s\S]*)<\/(?:\w:)?sheetPr)>/;
...
var require_dist = __commonJS({
  "node_modules/json-as-xlsx/dist/index.js"(exports, module) {
    ...
    var xlsx_1 = (init_xlsx(), __toCommonJS(xlsx_exports));
    Object.defineProperty(exports, "utils", { enumerable: true, get: function() {
      return xlsx_1.utils;
    } });
    var getContentProperty = (content, property) => {
      const accessContentProperties = (content2, properties2) => {
        const value = content2[properties2[0]];
        if (properties2.length === 1) {
          return value !== null && value !== void 0 ? value : "";
        }
        if (value === void 0 || typeof value === "string" || typeof value === "boolean" || typeof value === "number" || value instanceof Date) {
          return "";
        }
    ...
    var getJsonSheetRow = (content, columns) => {
      const jsonSheetRow = {};
    ...
    var xlsx = (jsonSheets, settings = {}, workbookCallback = () => {
    }) => {
...
*/
//# sourceMappingURL=json-as-xlsx.js.map
